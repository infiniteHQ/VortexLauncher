...
#define VORTEXLAUNCHER_VERSION     "1.5.1"
#define VORTEXLAUNCHER_VERSION_NUM 010501  // Major.Medium.Minor
...
#pragma clang diagnostic ignored "-Wreserved-identifier"  // warning: identifier '_Xxx' is reserved because it starts with
