...
VORTEX_API void VortexMaker::FindModulesInDirectoryRecursively(const std::string &directory, std::vector<std::shared_ptr<ModuleInterface>> &modules, std::atomic<bool>& stillSearching, std::string& elapsedTime)
{
